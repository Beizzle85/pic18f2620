...
e2bcd16u_Digit5Loop
        ...
        bra     e2bcd16u_Digit5Done ; MSB result was negative, add value back in, done with this digit.
        incf    AARGB0, F           ; Increment 10,000 digit in LS nibble of result byte.
        bra     e2bcd16u_Digit5Loop ; 10,000 digit not done yet.  
;
e2bcd16u_Digit5Done
        movf    TEMPB1, W
...
e2bcd16u_Digit4Loop
        ...
        subwf   BARGB0, F           ; Subtract MSB.
        btfss   _C                  ; Skip if MSB result is positive.
        bra     e2bcd16u_Digit4Done ; MSB result was negative, add value back in, done with this digit.
        incf    AARGB1, F           ; Increment 1,000 digit in LS nibble of result byte.
        bra     e2bcd16u_Digit4Loop ; 1,000 digit not done yet.  
;
e2bcd16u_Digit4Done
        movf    TEMPB1, W
        addwf   BARGB1, F           ; Add LSB.
...
e2bcd16u_Digit3Loop
        ...
        subwf   BARGB0, F           ; Subtract MSB.
        btfss   _C                  ; Skip if MSB result is positive.
        bra     e2bcd16u_Digit3Done ; MSB result was negative, add value back in, done with this digit.
        incf    AARGB1, F           ; Increment 100 digit in LS nibble of result byte.
        bra     e2bcd16u_Digit3Loop ; 100 digit not done yet.  
;
e2bcd16u_Digit3Done
        movf    TEMPB1, W
        addwf   BARGB1, F           ; Add LSB.
...
e2bcd16u_Digit2Loop
        ...
        subwf   BARGB1, F           ; Subtract LSB.
        btfss   _C                  ; Skip if LSB result is positive.
        bra     e2bcd16u_Digit2Done ; MSB result was negative, add value back in, done with this digit.
        incf    AARGB2, F           ; Increment 10 digit in LS nibble of result byte.
        bra     e2bcd16u_Digit2Loop ; 10 digit not done yet.  
;
e2bcd16u_Digit2Done
        movf    TEMPB1, W
        addwf   BARGB1, F           ; Add LSB.
...
e2bcd8u_Digit3Loop
        ...
        btfss   _C                  ; Skip if LSB result is positive.
        bra     e2bcd8u_Digit3Done  ; MSB result was negative, add value back in, done with this digit.
        incf    AARGB0, F           ; Increment 100 digit in LS nibble of result byte.
        bra     e2bcd8u_Digit3Loop  ; 100 digit not done yet.  
;
e2bcd8u_Digit3Done
...
e2bcd8u_Digit2Loop
        subwf   BARGB0, F           ; Subtract LSB.
        btfss   _C                  ; Skip if LSB result is positive.
        bra     e2bcd8u_Digit2Done  ; MSB result was negative, add value back in, done with this digit.
        incf    AARGB1, F           ; Increment 10 digit in LS nibble of result byte.
        bra     e2bcd8u_Digit2Loop  ; 10 digit not done yet.  
;
e2bcd8u_Digit2Done
        addwf   BARGB0, F           ; Add value back in.
